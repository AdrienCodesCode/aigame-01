...
DogController::DogController(DogControllerConfiguration configuration, bool gate_open) noexcept
    : configuration_{configuration}, collision_{gate_open}, state_{configuration.initial_state} {
